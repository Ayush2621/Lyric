...
const songsDB = [
    ...
    {
        "name": "; Kole Bheja ; Luv Sharma ¦ Seera Buttar ¦ Harssh Dada",
        "artist": "Unknown Artist",
    ...
    {
        "name": "; Masakali ¦ Delhi 6 ¦ Abhishek Bachchan, Sonam Kapoor ¦ A R Rahman ¦ Mohit Chauhan",
        "artist": "Unknown Artist",
    ...
    {
        "name": "'حصريا نجوى فاروق ; 'خلوني نعيش",
        "artist": "Exclusive ; Najwa Farouk 'Khalouni N3ich'",
    ...
    {
        "name": "#MAFIA# ¦ Aggressive Mafia Trap Rap Beat Instrumental ¦ Mafya Müziği ¦ Prod by Pasha Music",
        "artist": "Unknown Artist",
    ...
    {
        "name": "¦ Gehraiyaan ¦ Deepika Padukone, Siddhant, Ananya, Dhairya ¦ OAFF, Savera",
        "artist": "Doobey",
    ...
    {
        "name": "¦ Honey 3 0 ¦ Yo Yo Honey Singh & Sonakshi Sinha ¦ Zee Music Originals",
        "artist": "KALAASTAR",
    ...
    {
        "name": "¦ Jaundya Na Balasaheb ¦ Ajay-Atul ¦ Girish Kulkarni & Saie Tamhankar",
        "artist": "Dolby Walya",
    ...
    {
        "name": "¦ Shershaah ¦ Sidharth - Kiara ¦ Tanishk B¦ Jubin Nautiyal ¦Asees",
    ...
    {
        "name": "¦ Table No 21 ¦ Rajeev Khandelwal & Tina Desai ¦ Gajendra Verma",
        "artist": "Mann Mera",
    ...
    {
        "name": "¦¦Na cheli rojave song ¦¦A R Rahman",
        "artist": "Unknown Artist",
    ...
    {
        "name": "A R Rahman ¦ Guru ¦ Aishwarya Rai ¦ Abhishek Bachchan",
        "artist": "Tere Bina",
    ...
    {
        "name": "Aaj Ki Raat ¦ Stree 2 ¦ Tamannaah Bhatia ¦ Sachin–Jigar ¦ Madhubanti Bagchi ¦ Divya K ¦ Am…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Abhi Mujh Mein Kahin Best ¦Agneepath¦Priyanka Chopra,Hrithik¦Sonu Nigam",
        "artist": "Ajay-Atul",
    ...
    {
        "name": "Addy Nagar ¦ Music ¦ @AddyNagar",
        "artist": "Kaley Sheshe",
    ...
    {
        "name": "Alan Walker x King",
        "artist": "Story Of A Bird",
    ...
    {
        "name": "Alekhya Harika ¦ Vinay Shanmukh, Bharatt-Saurabh, Anirudh Ravichander, S Vijay",
        "artist": "Vellake Music",
    ...
    {
        "name": "All Time Superhit Song - Merupu Kalalu Telugu Movie",
        "artist": "Vennelave Vennelave",
    ...
    {
        "name": "ANIMAL;Evarevaro - ¦ Ranbir K, Rashmika,Anil K, Bobby D ¦ Sandeep V ¦ Vishal Mishra ¦ Bhus…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Anuvanuvuu Lyrical ¦ Om Bheem Bush ¦ Sree Vishnu¦ Arijit Singh ¦ Harsha Konuganti ¦Sunny M…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Arcade ¦ Netherlands 🇳🇱 ¦ Grand Final ¦ Winner of Eurovision 2019",
    ...
    {
        "name": "Arerey Manasa ¦ Vishwak Sen, Sid Sriram",
        "artist": "Falaknuma Das",
    ...
    {
        "name": "Avvy Sra ¦ Karan Aujla ¦ Jaani ¦ Amanninder Singh ¦ 8K",
        "artist": "White Brown Black",
    ...
    {
        "name": "Backbone ¦ Jaani ¦ B Praak ¦ Zenith Sidhu ¦ Music",
    ...
    {
        "name": "Bhairava Anthem ¦ Kalki 2898 AD ¦ Diljit Dosanjh ¦ Prabhas ¦ Santhosh Narayanan, Vijaynara…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Bhediya ¦ Varun Dhawan, Kriti Sanon¦ Sachin-Jigar, Arijit Singh, Amitabh Bhattacharya",
        "artist": "Apna Bana Le",
    ...
    {
        "name": "Bijlee Bijlee feat Palak Tiwari ¦ Jaani ¦ BPraak ¦ Arvindr Khaira ¦ Desi Melodies",
        "artist": "Harrdy Sandhu",
    ...
    {
        "name": "Brahmāstra ¦ Ranbir Kapoor, Alia Bhatt ¦ Pritam ¦ Arijit Singh ¦ Amitabh Bhattacharya¦ 4K",
        "artist": "Kesariya",
    ...
    {
        "name": "Bujji Thalli Lyrical ¦ Thandel ¦Naga Chaitanya, Sai Pallavi ¦ Javed Ali ¦Shree Mani ¦Devi…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "California Love Cheema Y ¦ Gur Sidhu ¦ Punjabi Song",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Check It Out",
        "artist": "Parmish Verma feat Paradox",
    ...
    {
        "name": "Chinnadhana With Telugu ¦¦'మా పాట మీ నోట'¦¦ Ishq Songs",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Chiru Chiru ¦ Yuvanshankar ¦ Karthi",
        "artist": "Awaara",
    ...
    {
        "name": "Chuttamalle ¦ Devara Second Single ¦ NTR ¦ Janhvi Kapoor ¦ Anirudh Ravichander ¦ Shilpa Ra…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Cover - Yohani & Satheeshan",
        "artist": "Manike Mage Hithe මැණිකේ මගේ හිතේ",
    ...
    {
        "name": "DAKU ¦ INDERPAL MOGA ¦ CHANI NATTAN ¦ NEW PUNJABI SONG ¦ LATEST PUNJABI SONG 2022 ¦Daku Ik…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "De De Pyaar De 2 ¦ Ajay, Rakul, Meezaan ¦ Payal D, Aditya D, Aditya R, Kumaar ¦ 14th Nov",
        "artist": "Raat Bhar",
    ...
    {
        "name": "Devil ¦ Trap ¦ NCS - Copyright Free Music",
        "artist": "Barren Gates",
    ...
    {
        "name": "DILBAR Lyrical ¦ Satyameva Jayate ¦John Abraham, Nora Fatehi,Tanishk B, Neha Kakkar,Dhvani…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Dreams pt II ¦ Trap ¦ NCS - Copyright Free Music",
        "artist": "Lost Sky",
    ...
    {
        "name": "Dunki Drop 5; O Maahi ¦ Shah Rukh Khan ¦ Taapsee Pannu ¦ Pritam ¦ Arijit Singh ¦ Irshad Ka…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "EITA NOVINHA DELICIA, ELA TÁ DE MARQUINHA DE FITA vs FUNK TIK TOK ¦ MC PÂNICO & DJ VT DA R…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Emo Emo Emo Song ¦¦ Raahu Movie ¦¦ Sid Sriram ¦¦ Praveen Lakkaraju ¦¦ Subbu Vedula ¦¦ Aber…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Falak Tak Song ¦ Tashan ¦ Akshay Kumar, Kareena Kapoor, Udit Narayan, Mahalaxmi Iyer, Vish…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "FAREBI ¦ Pyaar Diwaari Arc 3",
        "artist": "Chaar Diwaari X @raftaarmusic",
    ...
    {
        "name": "Fearless pt II ¦ Trap ¦ NCS - Copyright Free Music",
        "artist": "Lost Sky",
    ...
    {
        "name": "Genda Phool ¦ Jacqueline Fernandez ¦ Payal Dev ¦ Hit Anthem of the Year 2021",
        "artist": "Badshah",
    ...
    {
        "name": "Gym Class Heroes; Stereo Hearts feat Adam Levine",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Hanumankind - Big Dawgs ¦ Prod Kalmi ¦ Def Jam India",
    ...
    {
        "name": "Heeriye Jasleen Royal feat Arijit Singh¦ Dulquer Salmaan¦ Aditya Sharma ¦Taani Tanvir",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Hilesso Hilessa Lyrical ¦ Thandel ¦ Naga Chaitanya, Sai Pallavi ¦Nakash Aziz, Shreya Ghosh…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "I'm Done ¦ Maan Panu ¦ I-Popstar ; Vol 1 ¦ EP02 ¦ Amazon MX Player",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Idhedho Bagundhe Cheli Song ¦ Vijay Prakash,Sunitha Performance ¦ Super Masti ¦Ongole ¦7th…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Invisible ¦ Trap ¦ NCS - Copyright Free Music",
    ...
    {
        "name": "Jab Harry Met Sejal ¦ Shah Rukh Khan, Anushka ¦ Arijit Singh ¦ Pritam",
        "artist": "Hawayein Lyrical",
    ...
    {
        "name": "Jhoom Sharaabi – De De Pyaar De 2 ¦ Ajay Devgn, Rakul Preet Singh ¦ Yo Yo Honey Singh ¦ 14…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "KAATON ; JACK LOVE ¦ LUV SHARMA ¦ GXZ ¦ PUNJABI SONG",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Kabhi Jo Badal Barse Arijit Singh",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Kailash Kher ¦ ¦ Kailasa ¦ Paresh ¦ Naresh",
        "artist": "Teri Deewani",
    ...
    {
        "name": "Kailash Kher Live Performance at Isha Yoga Center",
        "artist": "Bam Lahiri",
    ...
    {
        "name": "Kaleshi Chori Pranjal Dahiya ¦ DG IMMORTALS, Raga, Harjas, Virtual AF, Sshiv ¦ Deepesh Goy…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Krish Rao ¦ Gully Gang Records ¦ Latest Haryanvi Song 2024",
        "artist": "Desi Hood",
    ...
    {
        "name": "Kufar I ¦ Diljit Dosanjh I Manushi Chhillar ¦ Aura I Raj Ranjodh I MixSingh",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Kya Baat Ay ¦ Jaani ¦ B Praak ¦ Arvindr Khaira ¦ Music",
        "artist": "Harrdy Sandhu",
    ...
    {
        "name": "Lyrical ¦ Atif Aslam ¦ Ajab Prem Ki Ghazab Kahani ¦ 2009",
        "artist": "Tu Jaane Na",
    ...
    {
        "name": "Lyrical ¦ Court ¦ Priyadarshi, Harsh Roshan, Sridevi ¦ Vijai Bulganin ¦ Ram Jagadeesh",
        "artist": "Premalo",
    ...
    {
        "name": "Lyrical ¦ Kanguva ¦ Suriya ¦ Devi Sri Prasad ¦ Siva ¦ Anurag Kulkarni",
        "artist": "Fire Song",
    ...
    {
        "name": "Lyrical ¦ Laila Majnu ¦ Jyotica Tangri ¦ Avinash Tiwary & Tripti Dimri",
        "artist": "O Meri Laila",
    ...
    {
        "name": "Lyrical ¦ Raees ¦ Shah Rukh Khan ¦ Arijit Singh & Harshdeep K ¦ JAM8-Pritam",
        "artist": "Zaalima",
    ...
    {
        "name": "Main Tera Boyfriend Song ¦ Raabta ¦ Arijit S ¦ Neha K Meet Bros ¦ Sushant Singh Rajput Kri…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Manoharudu - Nuvvunte Naa Jathagaa ¦ Vikram, Amy Jackson ¦ A R Rahman",
        "artist": "I",
    ...
    {
        "name": "MELODIA ENVOLVENTE 4 2021",
        "artist": "MONTAGEM",
    ...
    {
        "name": "Metro…In Dino; Zamaana Lage ¦ Anurag Basu ¦ Pritam ¦ Arijit Singh, Shashwat S ¦ Bhushan Ku…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Music Film I Amir Ameer I Faheem Abdullah I Rauhan Malik I Samreen Kaur I Mir Tafazul",
        "artist": "ISHQ",
    ...
    {
        "name": "My Love Is Gone ¦ Allu Arjun ¦ Devi Sri Prasad",
        "artist": "Aarya-2",
    ...
    {
        "name": "Naah Goriye -Bala ¦ Ayushmann Khurrana ¦ Harrdy Sandhu ¦ Swasti Mehul ¦B Praak ¦ Jaani ¦ S…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Narsingi Narsing Rao Anna Singing Live At Secunderabad Bonalu¦ Chuttu Muttu Hyderabadu Son…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Neelanjana Ray and Divya Kumar Performs On Sun Saathiya ¦ The Voice India Kids ¦ Episode 3…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Nijame Ne Lyrical ¦ Ooru Peru Bhairavakona ¦ Sundeep Kishan ¦ Sid Sriram ¦ VI Anand ¦ Shek…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "OG Glimpse ¦ Pawan Kalyan ¦ Sujeeth ¦ Thaman S ¦ DVV Danayya",
        "artist": "Hungry Cheetah",
    ...
    {
        "name": "Okey Oka Lokam Lyrical ¦ Sashi Songs ¦ Aadi ¦ Sid Sriram ¦ Srinivas Naidu Nadikatla ¦ Arun…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Old Town Road feat Billy Ray Cyrus",
        "artist": "Lil Nas X",
    ...
    {
        "name": "On & On ¦ Electronic Pop ¦ NCS - Copyright Free Music",
        "artist": "Cartoon, Jéja",
    ...
    {
        "name": "On Top Karan Aujla ¦ Yeah Proof ¦ New Punjabi Songs 2022",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Orange Songs - Ram Charan Tej, Genelia-Aditya Music Telugu",
        "artist": "Chilipiga Choosthavala Song With",
    ...
    {
        "name": "Ordinary Person ¦ Thalapathy Vijay ¦ Anirudh Ravichander",
        "artist": "Leo",
    ...
    {
        "name": "Pav Dharia ¦ 4K ¦ Dance Hit ¦ Punjabi Songs ¦ #pavdharia #najanaja",
        "artist": "Na Ja",
    ...
    {
        "name": "Peaky Blinder ¦ i am not outsider i'm a peaky blinder",
        "artist": "Otnicka",
    ...
    {
        "name": "Psycho Saiyaan ¦ Saaho ¦ Prabhas, Shraddha Kapoor ¦ Tanishk Bagchi, Dhvani Bhanushali, Sac…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Pushpa Pushpa -Pushpa 2 The Rule ¦ Allu Arjun ¦Sukumar ¦Rashmika ¦Mika,Nakash ¦Fahadh F¦DS…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Qaafirana ¦ Kedarnath ¦ Sushant Rajput ¦ Sara Ali Khan ¦ Arijit Singh & Nikhita ¦ Amit Tri…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Raabta With ¦ Agent Vinod ¦ Saif Ali Khan, Kareena Kapoor,Pritam",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Ram Siya Ram Sachet Tandon ¦ Poonam Thakkar ¦ Shabbir Ahmed ¦ Sidhika Sharma ¦ T-Series",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Ranbir, Anushka, Aishwarya ¦ Arijit Singh¦ Pritam",
        "artist": "Ae Dil Hai Mushkil Title Track",
    ...
    {
        "name": "Russian Bandana ¦ Deepesh Goyal ¦ VYRL Haryanvi",
        "artist": "Dhanda Nyoliwala",
    ...
    {
        "name": "Sachin Jaat ¦ Babli Jhuriya ¦ Masoom Sharma & Swara Verma",
        "artist": "Gundey Dore Pe",
    ...
    {
        "name": "Sajni ; Arijit Singh, Ram Sampath ¦ Laapataa Ladies ¦ Aamir Khan Productions",
        "artist": "Unknown Artist",
    ...
    {
        "name": "See Me Fall feat Kensei Abbot",
        "artist": "Ro Ransom",
    ...
    {
        "name": "Shahrukh Khan,Rani Mukherjee¦Shafqat Amanat Ali¦Shankar Mahadevan",
        "artist": "Mitwa , KANK",
    ...
    {
        "name": "Shaky Sanju Rathod feat Isha Malviya ¦ G-Spark ¦ New #Marathi Songs 2025",
        "artist": "Unknown Artist",
    ...
    {
        "name": "SHAM DI LAALI ¦ Basant Kur ¦ Navvi ¦ MY NAME IS STREET",
        "artist": "Wazir Patar",
    ...
    {
        "name": "Shershaah ¦ Jasleen Royal ¦ Sidharth–Kiara ¦ B Praak ¦ Romy ¦ Anvita Dutt",
        "artist": "Ranjha Reprise",
    ...
    {
        "name": "Sky High ¦ Progressive House ¦ NCS - Copyright Free Music",
        "artist": "Elektronomia",
    ...
    {
        "name": "Song ¦ HIT 2 ¦ Adivi Sesh ¦ Meenakshi ¦ MM Sreelekha ¦ Sid Sriram",
        "artist": "Urike Urike",
    ...
    {
        "name": "Song ¦ Kalki 2898 AD ¦ Prabhas ¦ Disha Patani ¦ Santhosh Narayanan",
        "artist": "Ta Takkara",
    ...
    {
        "name": "Song feat Sid Sriram ¦ Gauthamante Radham ¦ Neeraj Madhav ¦Ankit Menon ¦Anand Menon ¦4K",
        "artist": "UYIRE",
    ...
    {
        "name": "SUKHA ¦ GURLEZ AKHTAR ¦ CHANI NATTAN ¦ PRODGK",
        "artist": "8 ASLE",
    ...
    {
        "name": "Teaser ¦ Crew ¦ Badshah ¦ Raj Ranjodh",
        "artist": "Naina x Diljit Dosanjh",
    ...
    {
        "name": "Tere Ishk Mein ¦ Dhanush, Kriti S ¦ AR Rahman, Arijit Singh, Irshad K ¦ Aanand LR ¦ Bhusha…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Teri Meri Kahaani Reprise ¦ Chirantan Bhatt feat Palak Muchhal , Manoj Yadav ¦ Gaurav Jang",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Title Track ¦ Ranveer Singh, Shashwat Sachdev, Hanumankind, Jasmine Sandlas,Aditya Dhar",
        "artist": "Dhurandhar",
    ...
    {
        "name": "Tony Kakkar feat Young Desi ¦ RE-UPLOADED AFTER 170 MILLION VIEWS",
        "artist": "Coca Cola Tu",
    ...
    {
        "name": "TU JOGA PRA TRAS TU ENCOSTA ENCOSTA",
        "artist": "DJ Dn o Astro, Mc Mascara, Rodrigo do Cn",
    ...
    {
        "name": "Tujh Mein Rab Dikhta Hai - Rab Ne Bana Di Jodi",
        "artist": "Flute",
    ...
    {
        "name": "Tum Hi Ho Soulful ¦ Mithoon ¦ MTV Unplugged",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Uppenantha ¦ Allu Arjun ¦ Devi Sri Prasad",
        "artist": "Aarya-2",
    ...
    {
        "name": "Uyire Uyire ¦ Song ¦ Anup Rubens ¦ Adnan Sami, Chinmayi",
        "artist": "Oh Priya Priya",
    ...
    {
        "name": "Vaaste Song; Dhvani Bhanushali, Tanishk Bagchi ¦ Nikhil D'Souza ¦ Bhushan Kumar ¦ Radhika…",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Varinder Brar ¦ New Punjabi Song 2021 ¦ Latest punjabi songs 2021",
        "artist": "12 Bande",
    ...
    {
        "name": "VICTORY ANTHEM- Khushi× @lashcurry prod by @AudiocrackerrBeatz1",
        "artist": "Unknown Artist",
    ...
    {
        "name": "Viral Attitude Song 👿👿",
        "artist": "Moti Chain Mota Paisa",
...
function isAndroidApp() {
  return typeof window.Android !== 'undefined' && typeof window.Android.loadData === 'function';
}
...
function loadPlaylists() {
  try {
    let raw = null;
    if (isAndroidApp()) {
      raw = window.Android.loadData(STORAGE_PLAYLISTS_KEY) || null;
      console.log("Loaded playlists from native Android storage.");
    } else {
      raw = localStorage.getItem(STORAGE_PLAYLISTS_KEY);
      console.log("Loaded playlists from browser localStorage.");
    }
...
function savePlaylists(obj) {
  try {
    ...
    if (isAndroidApp()) {
      window.Android.saveData(STORAGE_PLAYLISTS_KEY, raw);
      console.log("Saved playlists to native Android storage.");
    } else {
      localStorage.setItem(STORAGE_PLAYLISTS_KEY, raw);
      console.log("Saved playlists to browser localStorage.");
    }
  } catch (e) {
...
/* Defensive checks for elements that might be missing */
function elSafe(el, fallback = null) { return el || fallback; }
...
function updateNowPlaying(song) {
  ...
  if (cover) {
    ...
    // else leave existing src (default-cover.jpg)
  }
...
function updateUIPlayingState() {
  ...
  if (miniPlayIcon) {
    if (playing) {
      // Show pause bars
      miniPlayIcon.innerHTML = '<rect x="6" y="5" width="4" height="14" fill="white"/><rect x="14" y="5" width="4" height="14" fill="white"/>';
      miniPlayToggle.setAttribute('aria-pressed', 'true');
    } else {
      // Show play triangle
      miniPlayIcon.innerHTML = '<path d="M5 3v18l15-9L5 3z" fill="white"/>';
      miniPlayToggle.setAttribute('aria-pressed', 'false');
    }
  }

  // Update play indicators in list
  document.querySelectorAll('.song').forEach(el => {
    const pid = el.dataset.id;
    const ind = el.querySelector('.play-indicator');
    if (ind) ind.style.display = (pid === currentSongId && playing) ? 'block' : 'none';
  });
  ...
  // Visual state for shuffle/repeat buttons
...
function togglePlaySong(songId) {
  ...
  if (currentSongId === songId) {
    if (audio.paused) audio.play().catch(e => console.warn('Play blocked:', e));
    else audio.pause();
  } else {
    currentSongId = songId;
    audio.src = song.src || '';
    audio.currentTime = 0;
    audio.play().catch(e => console.error("Playback failed. Check song source:", song.src, e));
    updateNowPlaying(song);
  }
  updateUIPlayingState();
}

function findNextIndexInPlaylist(listIds, currentId) {
  return listIds.indexOf(currentId);
}

function playNextSong() {
  if (shuffleEnabled) {
    // Play random song from full DB or from current playlist if one is selected
    const pool = currentPlaylistName && playlists[currentPlaylistName] && playlists[currentPlaylistName].length
      ? playlists[currentPlaylistName].slice()
      : songsDB.map(s => s.id);
    if (!pool.length) return;
    // Don't pick the same song if more than one item
    let nextId;
    if (pool.length === 1) nextId = pool[0];
    else {
      do {
        nextId = pool[Math.floor(Math.random() * pool.length)];
      } while (nextId === currentSongId && pool.length > 1);
    }
    togglePlaySong(nextId);
    return;
  }

  if (!currentPlaylistName) {
    // If no playlist selected, move to next in DB
    const ids = songsDB.map(s => s.id);
    const idx = ids.indexOf(currentSongId);
    if (idx >= 0 && idx < ids.length - 1) togglePlaySong(ids[idx + 1]);
    else {
      if (repeatMode === 'all') togglePlaySong(ids[0]);
      else {
        audio.pause();
        audio.currentTime = 0;
        currentSongId = null;
  ...
  const playlistIds = playlists[currentPlaylistName] || [];
  if (!playlistIds || !playlistIds.length) return;

  const currentIndex = playlistIds.indexOf(currentSongId);
  if (currentIndex >= 0 && currentIndex < playlistIds.length - 1) {
    togglePlaySong(playlistIds[currentIndex + 1]);
  } else {
    if (repeatMode === 'all') {
      togglePlaySong(playlistIds[0]);
    } else {
      if (repeatMode === 'one') {
        // repeat current
        togglePlaySong(currentSongId);
      } else {
        // stop / reset
        audio.pause();
        audio.currentTime = 0;
...
function playPrevSong() {
  ...
  if (!currentPlaylistName) {
    const ids = songsDB.map(s => s.id);
    const idx = ids.indexOf(currentSongId);
    if (idx > 0) togglePlaySong(ids[idx - 1]);
    else togglePlaySong(ids[0]);
    return;
  }

  const playlistIds = playlists[currentPlaylistName] || [];
  const currentIndex = playlistIds.indexOf(currentSongId);
  if (currentIndex > 0) togglePlaySong(playlistIds[currentIndex - 1]);
  else togglePlaySong(playlistIds[0]);
}

/* ===== 7. Song List Renderer (Home view) ===== */
function renderSongs(list) {
  ...
  list.forEach(song => {
    ...
    cover.textContent = (song.name || '').split(' ').slice(0, 2).map(w => w[0]).join('').toUpperCase();

    const meta = document.createElement('div');
    meta.className = 'meta';
    const name = document.createElement('div'); name.className = 'name'; name.textContent = song.name || 'Unknown';
    const artist = document.createElement('div'); artist.className = 'artist'; artist.textContent = song.artist || 'Unknown';
    ...
    playBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M5 3v18l15-9L5 3z" fill="white"/></svg>`;
    ...
    playIndicator.style.display = (song.id === currentSongId && !audio.paused) ? 'block' : 'none';

    const menuWrap = document.createElement('div');
    menuWrap.className = 'menu';
    const menuBtn = document.createElement('button');
    menuBtn.className = 'btn-circle';
    menuBtn.title = 'Options';
    menuBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="6" r="1.6" fill="white"/><circle cx="12" cy="12" r="1.6" fill="white"/><circle cx="12" cy="18" r="1.6" fill="white"/></svg>`;
    menuBtn.addEventListener('click', (evt) => {
      evt.stopPropagation();
      toggleMenuForSong(menuWrap, song);
    });

    menuWrap.appendChild(menuBtn);

    controls.appendChild(playBtn);
    controls.appendChild(playIndicator);
...
/* ===== 8. Event Listeners (Audio, Controls, Seeking) ===== */
if (miniPlayToggle) miniPlayToggle.addEventListener('click', () => {
  if (!audio.src) return;
  if (audio.paused) audio.play().catch(e => console.warn('Play blocked:', e));
  else audio.pause();
});
...
/* ===== 10. Menu logic (add to playlist / create) ===== */
let openMenu = null;
function toggleMenuForSong(menuWrap, song) {
  closeOpenMenu();
  const tpl = document.getElementById('menuTemplate').content.cloneNode(true);
  const menuList = tpl.querySelector('.menu-list');

  menuList.querySelector('[data-action="create"]').addEventListener('click', (e) => {
    e.stopPropagation();
    const name = prompt('Create playlist name:');
    if (name && name.trim()) createPlaylist(name.trim(), [song.id]);
    closeOpenMenu();
  });

  menuList.querySelector('[data-action="add"]').addEventListener('click', (e) => {
    e.stopPropagation();
  ...
  openMenu = menuList;
  setTimeout(() => document.addEventListener('click', outsideMenuHandler), 20);
}
...
function outsideMenuHandler(e) {
  if (!openMenu) return;
  if (!openMenu.contains(e.target)) closeOpenMenu();
}

/* ===== 11. Create / Add to playlist UI ===== */
function createPlaylist(name, initialSongs = []) {
  ...
  if (initialSongs.length > 0) alert(`Playlist "${name}" created and song added!`);
  else alert(`Playlist "${name}" created!`);
  if (libraryView.style.display === 'block') renderLibraryIndex();
}

function showAddToPlaylistDialog(songId) {
  const names = Object.keys(playlists || {});
  if (names.length === 0) {
    if (confirm('No playlists exist yet. Create a new one?')) {
      const name = prompt('New playlist name:');
      if (name) createPlaylist(name, [songId]);
    }
    return;
  }

  const listText = names.map((n, i) => `${i + 1}. ${n} (${playlists[n].length})`).join('\n');
  const pick = prompt('Add to which playlist? Enter number:\n' + listText);
  if (!pick) return;
  ...
  const pname = names[idx];
  if (!playlists[pname]) playlists[pname] = [];
  if (playlists[pname].includes(songId)) {
    alert(`Song is already in playlist "${pname}".`);
    return;
  }
  playlists[pname].push(songId);
  savePlaylists(playlists);
  alert(`Added to "${pname}"`);
}

/* ===== 12. Library / Playlist view (Full-Page Logic) ===== */
function renderLibraryIndex() {
  ...
  createNewBtn.className = 'btn-circle';
  createNewBtn.style.background = 'var(--accent)';
  createNewBtn.style.color = '#000';
  createNewBtn.innerHTML = '✚';
  createNewBtn.title = 'Create New Playlist';
  ...
  if (names.length === 0) {
    ...
    emptyMessage.textContent = 'No playlists yet. Click the ✚ to create one.';
  ...
  names.forEach(name => {
    ...
    const titleEl = document.createElement('div'); titleEl.style.fontWeight = '700'; titleEl.textContent = name;
    const count = document.createElement('div'); count.style.color = 'var(--muted)'; count.style.fontSize = '13px';
    count.textContent = `${(playlists[name] || []).length} songs`;
...
function openPlaylistDetail(name) {
  ...
  backBtn.addEventListener('click', () => renderLibraryIndex());
  ...
  if (playlistSongs.length === 0) {
    libraryList.innerHTML += `<div class="empty">Playlist empty. Add songs from Home by clicking the options menu (···) on a track.</div>`;
    return;
  }
  ...
  playlistSongs.forEach(song => {
    ...
    const meta = document.createElement('div');
    meta.className = 'meta';
    const nameEl = document.createElement('div'); nameEl.className = 'name'; nameEl.textContent = song.name || 'Unknown';
    const artist = document.createElement('div'); artist.className = 'artist'; artist.textContent = song.artist || 'Unknown';
    ...
    const playBtn = document.createElement('button');
    playBtn.className = 'btn-circle';
    playBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 24 24"><path d="M5 3v18l15-9L5 3z" fill="white"/></svg>`;
    ...
    removeBtn.className = 'btn-circle';
    removeBtn.title = 'Remove from playlist';
    removeBtn.innerHTML = '−';
    removeBtn.addEventListener('click', (e) => {
      e.stopPropagation();
      if (confirm(`Remove "${song.name}" from playlist "${name}"?`)) {
        playlists[name] = (playlists[name] || []).filter(x => x !== song.id);
        savePlaylists(playlists);
    ...
    row.addEventListener('click', () => togglePlaySong(song.id));
...
function init() {
  audio.volume = 1;
  if (!Array.isArray(songsDB) || !songsDB.length) {
  ...
  // Expose API for Android WebView
  window.loadPlaylists = loadPlaylists;
  window.savePlaylists = savePlaylists;
  window.createPlaylist = createPlaylist;
  window.showAddToPlaylistDialog = showAddToPlaylistDialog;
  window.renderLibraryIndex = renderLibraryIndex;

  if (isAndroidApp()) {
    try { window.Android.onReady && window.Android.onReady(); } catch(e){/* ignore */ }
