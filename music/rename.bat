@echo off
echo =================================================
echo   Cleaning all .mp3 filenames in this folder...
echo   Folder: %~dp0
echo =================================================
echo.
